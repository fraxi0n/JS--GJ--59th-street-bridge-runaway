...
function load()
{
    ...
    voitureBoom.img[1].src = "sprite/boom1.png"
    voitureBoom.img[2].src = "sprite/boom2.png"
    voitureBoom.img[3].src = "sprite/boom3.png"

    voiture.x=30
    voiture.y=V [voiture.V]

    roadEcartX = imgMainRoad.length


    //voiture = new Sprite ("sprite/voiture.png",30,V[2] )
    bulle = new Sprite ("sprite/bulle.png",50,20 )
    fondFixe = new Sprite ("sprite/fond.png")
